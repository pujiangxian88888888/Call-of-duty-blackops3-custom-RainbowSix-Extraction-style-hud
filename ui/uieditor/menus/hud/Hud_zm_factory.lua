...
require( "ui.uieditor.widgets.HUD.PerksWidget.PerksContainer" )
require( "ui.uieditor.widgets.HUD.ScoreWidget.ScoreContainer" )
require( "ui.uieditor.widgets.HUD.AmmoWidget.AmmoContainer" )
...
LUI.createMenu.T7Hud_zm_factory = function ( controller )
	...
	self.ZMPerksContainerFactory = CoD.PerksContainer.new( self, controller )
