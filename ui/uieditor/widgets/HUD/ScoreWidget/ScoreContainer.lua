...
require( "ui.uieditor.widgets.HUD.ScoreWidget.ClientScore" )
require( "ui.uieditor.widgets.HUD.ScoreWidget.SelfScore" )
...
CoD.ScoreContainer = InheritFrom( LUI.UIElement )
CoD.ScoreContainer.new = function ( menu, controller )
	...
	self:setClass( CoD.ScoreContainer )
	self.id = "ScoreContainer"
	...
	self.ListingUser:setWidgetType( CoD.SelfScore )
	...
	self.Listing2 = CoD.ClientScore.new( menu, controller )
	...
	self.Listing3 = CoD.ClientScore.new( menu, controller )
	...
	self.Listing4 = CoD.ClientScore.new( menu, controller )
